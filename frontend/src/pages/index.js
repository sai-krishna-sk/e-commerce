    ...
    <div className="min-h-screen relative bg-gray-50">
      ...
      <div className="relative z-10">
        ...
        <div className="relative h-160 w-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[url('https://img.freepik.com/premium-photo/luxury-jewelry-black-friday-advertisement-commercial-photography_950002-326749.jpg?w=1060')] bg-cover bg-center opacity-80"></div>
